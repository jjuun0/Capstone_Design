...
from TransMixing.style_mixing.nonlinear_mixing import MixingTransformer
...
def train(save_name, img_name, preserve_color_info='refer'):
    ...
    if gan_inversion == 'e4e':
        from TransMixing.gan_inversion.e4e_projection import projection as e4e_projection
    elif gan_inversion == 'ii2s':
        from TransMixing.gan_inversion.ii2s_projection import projection as ii2s_projection
    elif gan_inversion == 'restyle':
        from TransMixing.gan_inversion.restyle_projection import projection as restyle_projection
