...
def image_align(src_file, output_size=1024, transform_size=4096, enable_padding=True):
        ...
        # Save aligned image.
        # img.save('test_input/aligned_images', 'PNG')
...
if __name__ == '__main__':
    ...
    parser.add_argument('-s', '--src', default='./test_input', help='directory of raw images')
    parser.add_argument('-d', '--dst', default='./test_input/aligned_images', help='directory of aligned images')
